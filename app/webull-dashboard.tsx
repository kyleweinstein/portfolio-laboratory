...
function stateFailure(error: unknown): LoadFailure {
  if (error instanceof WebullApiError) {
    ...
    if (error.status === 401 || error.status === 403) return { kind: "unauthorized", message: error.message };
